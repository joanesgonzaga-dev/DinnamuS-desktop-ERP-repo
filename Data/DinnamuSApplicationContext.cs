...
namespace DinnamuS_2._0_Desktop.Data
{
    class DinnamuSApplicationContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseNpgsql("Server = 192.168.0.8; Port = 5432; Database = Principal; User Id = postgres; Password=senh@654321", optionsBuilder => optionsBuilder.SetPostgresVersion(9, 6));
